...
import PlusB from '../../public/assets/Plus.svg'
    ...
    return (
        <div className="flex flex-col w-full py-[48px] lg:py-[60px] lg:flex-row gap-x-6">
            <div className=" lg:w-1/3 lg:py-[32px] lg:pr-[56px]">
                ...
                <h1 className=" py-4 text-2xl font-medium text-[#172026] lg:text-[42px] leading-[58px]">Lets clarify some of your questions </h1>
                            ...
                            <Accordion.Item value={`item-${index + 1}`} className='bg-[#E3F1FF] p-[16px] rounded-[8px]'>
                                <Accordion.Header>
                                    <Accordion.Trigger className=' flex w-full items-center justify-between '>
                                        ...
                                        <span>
                                            <Image src={PlusB} alt='PlusB' className='h-10 w-10 lg:w-6 lg:h-6' />
                                        </span>
                                    </Accordion.Trigger>
                                </Accordion.Header>
                                <Accordion.Content>
